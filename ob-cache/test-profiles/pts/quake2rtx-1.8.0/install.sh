...
# Base constants
#
export QUAKE_LOG_FILE=".local/share/quake2rtx/baseq2/logs/console.log"

tar -xf q2rtx-1.8.0-linux.tar.gz
...
#
cd q2rtx
./q2rtx +set ray_tracing_api \${RT_BACKEND} +demo q2demo1.dm2 +timedemo 1 +set r_mode -1 +set r_customwidth \$1 +set r_customheight \$2 +set vid_fullscreen 1 +set pt_num_bounce_rays \${GLOBAL_ILLUMINATION} +set flt_enable \${FLT_ENABLE} +set nextserver quit
cd -
