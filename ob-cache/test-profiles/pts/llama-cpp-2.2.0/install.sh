#!/bin/bash
tar -xf llama.cpp-b6401.tar.gz
rm -rf llama.cpp-BLAS
rm -rf llama.cpp-CUDA
cp -va llama.cpp-b6401 llama.cpp-BLAS
cd llama.cpp-BLAS
...
if which nvcc >/dev/null 2>&1 ;
then
	cp -va llama.cpp-b6401 llama.cpp-CUDA
	cd llama.cpp-CUDA
...
then
	...
	cp -va llama.cpp-b6401 llama.cpp-ROCM
	cd llama.cpp-ROCM
...
unzip -o ../llama-b6401-bin-ubuntu-vulkan-x64.zip
cd ~
rm -rf llama.cpp-b6401
echo "#!/bin/bash
