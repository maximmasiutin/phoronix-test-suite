...
class test_timeout extends pts_module_interface
{
	...
	public static function __pre_test_run(&$test_run_request)
	{
		...
		if(self::$time_to_allow_for_current_test > 0)
		{
			...
			$test_run_request->pre_run_message = 'Test will timeout after ~' . strtolower(pts_strings::format_time(self::$time_to_allow_for_current_test, 'SECONDS', true, 60)) . ' if any individual test run is incomplete/hung.';
		}
	}
